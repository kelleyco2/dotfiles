...
- Per-project `CLAUDE.md` files (most of my repos have one) own the specifics — defer to them.

## Primary stack — Next.js
Most of my work is Next.js apps. Defaults unless a repo says otherwise:
- **Next 16 / React 19 / TypeScript** (strict), **App Router**, `@/*` → `src/*`.
...
- These libraries moved past your knowledge cutoff — look up specifics (Tailwind v4, Next 16,
