return {
	...
	-- 		vim.g.neoformat_enabled_markdown = { "biome" }
	-- 		vim.g.neoformat_enabled_html = { "biome" }
	-- 		vim.g.neoformat_enabled_svelte = { "prettierd" }
	-- 		vim.g.neoformat_enabled_lua = { "stylua" }
	-- 		vim.g.neoformat_enabled_elixir = { "mixformat" }

	-- 		-- Project-specific formatter overrides
	-- 		-- local function set_omnus_formatters()
	-- 		-- 	local cwd = vim.fn.getcwd()
	-- 		-- 	if string.find(cwd, "omnus") then
	...
	-- 		-- Set formatters when entering a buffer
	-- 		-- vim.api.nvim_create_autocmd({ "BufEnter", "DirChanged" }, {
	-- 		-- callback = set_omnus_formatters,
	-- 		-- })

	-- 		-- Set formatters on initial load
	-- 		-- set_omnus_formatters()
	-- 	end,
	-- },
